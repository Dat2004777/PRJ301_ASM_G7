<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <div>
        ...
        <div style="width: 280px;" class="offcanvas-lg offcanvas-start bg-dark text-white" tabindex="-1"
                ...
                <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
                    <a href="admin"
                        ...
                        <img class="logo-img rounded-circle"
                            src="${pageContext.request.contextPath}/assests/img/logoWebsite.jpg" alt="logo">
                        <span class="ms-2 fs-4">Admin Controller</span>
                    </a>
                    <hr>
                    <ul class="nav nav-pills flex-column mb-auto">
                        <li class="nav-item">
                            <a href="admin" class="nav-link text-white ${param.activePage == 'admin' ? 'active' : ''}" aria-current="page">
                        ...
                        <li>
                            <a href="list-site" class="nav-link text-white ${param.activePage == 'list-site' ? 'active' : ''}">
                                <svg class="bi me-2" width="16" height="16">
                        ...
                        <li>
                            <a href="list-employee" class="nav-link text-white ${param.activePage == 'list-employee' ? 'active' : ''}">
                                <svg class="bi me-2" width="16" height="16">
                    ...
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                            ...
                            <img src="${pageContext.request.contextPath}/assests/img/avt.jpg" alt="" width="32"
