<%-- 
    Document   : add-site
    Created on : 31 Jan 2026, 17:47:55
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="main-container">
            <div class="form-card">
                <h2 class="form-title">Thêm bãi xe</h2>

                <div class="sub-title">Thông tin Bãi Xe</div>

                <form action="site-controller" method="post">
                    <div class="form-group">
                        <label class="form-label">Tên bãi xe</label>
                        <input type="text" name="siteName" class="form-input" placeholder="Tên bãi xe">
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <button type="submit" class="btn btn-save">Lưu bãi xe</button>
                    </div>
                </form>
            </div>
        </div>
