        ...
        <div class="main-container">
            ...
            <div class="parking-grid">
                ...
                <div class="parking-card">
                    <img src="https://via.placeholder.com/600x300" alt="Bãi xe Cầu Giấy" class="card-img-top">
                    <div class="card-body">
                        <div class="card-row">
                            <span class="site-name">Bãi xe Cầu Giấy</span>
                            <span class="site-region">Miền Bắc</span>
                        </div>
                        <div class="card-row">
                            <span class="site-address">Số 10 Phạm Văn Bạch, Hà Nội</span>
                            <span class="status-badge status-active">Đang hoạt động</span>
                        </div>
                        <div class="card-footer-row">
                            <span class="slots-info">150 slots</span>
                            <a href="#" class="btn-book">Đặt chỗ</a>
                        </div>
                    </div>
                </div>

                <div class="parking-card">
                    <img src="https://via.placeholder.com/600x300" alt="Bãi xe Quận 9" class="card-img-top">
                    <div class="card-body">
                        <div class="card-row">
                            <span class="site-name">Bãi xe Quận 9</span>
                            <span class="site-region">Miền Nam</span>
                        </div>
                        <div class="card-row">
                            <span class="site-address">Lô E2a-7, Đường D1, TPHCM</span>
                            <span class="status-badge status-active">Đang hoạt động</span>
                        </div>
                        <div class="card-footer-row">
                            <span class="slots-info">500 slots</span>
                            <a href="#" class="btn-book">Đặt chỗ</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="parking-card">
                    <img src="https://via.placeholder.com/600x300" alt="Bãi xe Đà Nẵng" class="card-img-top">
                    <div class="card-body">
                        <div class="card-row">
                            <span class="site-name">Bãi xe Đà Nẵng</span>
                            <span class="site-region">Miền Trung</span>
                        </div>
                        <div class="card-row">
                            <span class="site-address">Ngũ Hành Sơn, Đà Nẵng</span>
                            <span class="status-badge status-maintenance">Bảo trì</span>
                        </div>
                        <div class="card-footer-row">
                            <span class="slots-info">200 slots</span>
                            <a href="#" class="btn-book" style="background-color: #e74c3c;">Đặt chỗ</a> 
                        </div>
                    </div>
                </div>

                <div class="parking-card">
                    <img src="https://via.placeholder.com/600x300" alt="Bãi xe Cầu Giấy 2" class="card-img-top">
                    <div class="card-body">
                        <div class="card-row">
                            <span class="site-name">Bãi xe Cầu Giấy</span>
                            <span class="site-region">Miền Bắc</span>
